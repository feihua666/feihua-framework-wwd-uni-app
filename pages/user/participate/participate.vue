                	...
                	<view class="uni-card-content uni-list-cell">
						...
						<view class="uni-media-list">
							<view class="uni-media-list-logo">
								<image  :src="$config.file.getDownloadUrl(item.titleUrl) + '?x-oss-process=image/resize,h_528/auto-orient,1'"></image>
							</view>
							<view class="uni-media-list-body">
								...
								<view class="uni-media-list-text-bottom uni-ellipsis font-size-sm">{{item.introduced}}</view>
							</view>
						</view>
						</navigator>
                	</view>
